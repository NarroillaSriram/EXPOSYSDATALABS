...
from models.models import Student, Admin, Payment, Contact, Internship, AddonPayment, Certificate
...
def _issue_certificate(student_id, redirect_to=None, replace_existing=False):
    ...
    try:
        ...
        try:
            import requests
            node_url = "http://localhost:5000/api/blockchain/register"
...
def serve_cert_file(filepath):
    """Serve certificate PDFs and QR code images generated by the Python backend."""
